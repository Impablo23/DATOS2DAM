...
public class Filosofo implements Runnable{
    ...
    private void comer() throws InterruptedException {
        ...
        //Creamos un contador para obligar el sistema de que los filosofos coman todos por igual 5 veces
        contador++;
        System.out.println("Numero de comidas del filofoso "+Thread.currentThread().getName()+" : "+contador+"\n");;
